...
# Downloads v1 (older version of OSM2VectorTiles tiles) 

This page list links to the first version of OSM2VectorTiles tiles compatible with MapBox Streets V5 and many .tm2 projects and older JSON styles.
