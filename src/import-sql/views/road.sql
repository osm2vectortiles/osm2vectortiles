CREATE OR REPLACE VIEW osm_unique_road AS (
    SELECT rp.osm_id, rp.geometry, rp.type, rp.construction, rp.tracktype, rp.service, rp.access,
    ...
    UNION ALL
    SELECT rl.osm_id, rl.geometry, rl.type, rp.construction, rp.tracktype, rp.service, rp.access,
